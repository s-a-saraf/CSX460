...
predictedRes <- predict(logisticmodel, cv_set)

# Create a new table with "Actual OP"  "Predicted OP" for the cv_set
predictTable$actual_type <- cv_set$delayed
predictTable$predict_type <- predictedRes

# Create the confusion Matrix
predictTable <- confusionMatrix(predictTable$predict_type, predictTable$actual_type, positive = "1")
