...
str(df_join_df_flight_name_join_weather2_join_origin_airports_by_dest_airport)
```
...
summary(df_join_df_flight_name_join_weather2_join_origin_airports_by_dest_airport$arr_delay)

hist(df_join_df_flight_name_join_weather2_join_origin_airports_by_dest_airport$arr_delay)

ggplot(data=df_join_df_flight_name_join_weather2_join_origin_airports_by_dest_airport, aes(x=arr_delay)) + geom_histogram()

ggplot(data=df_join_df_flight_name_join_weather2_join_origin_airports_by_dest_airport, aes(x=log(10, df_join_df_flight_name_join_weather2_join_origin_airports_by_dest_airport$arr_delay))) + geom_histogram()


ggplot(data=df_join_df_flight_name_join_weather2_join_origin_airports_by_dest_airport, aes(x=arr_delay)) + geom_histogram() + scale_x_sqrt()

ggplot(data=df_join_df_flight_name_join_weather2_join_origin_airports_by_dest_airport, aes(x=arr_delay)) + geom_histogram() + scale_x_log10("Arrival Delay") + scale_y_continuous("Count")
```
